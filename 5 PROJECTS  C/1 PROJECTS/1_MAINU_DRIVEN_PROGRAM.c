...
{
    char c;
    int ch, ch1, ch2, ch3, ch4, ch5, ch6, ch7, ch8, ch9, ch10, ch11, ch12, ch13, num, tsec, min, sec, year, ans, length, breadth, radius, sp, pp, unit, principal, num_of_years, a1, a2, a3, s1, s2, s3;
    float fno, sno, tno, num1, num2, num3, num4, num5, num6, num7, num8, kilometer, meter, f, rate_of_interest, sub_result, multi_result, month, rs;
    do
    {
    start:
